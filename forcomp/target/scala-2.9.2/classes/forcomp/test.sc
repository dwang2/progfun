...
object test {
 ...
 def translate(number: String): Set[String] =
 	...
 	translate("7225247386")                   //> res5: Set[String] = Set(sack air fun, pack ah re to, pack bird to, Scala ir
 	...
 	translate("8643226")                      //> res7: Set[String] = Set(to if can, to he ban, to Ida am, void cam, to he ca
                                                  //| n, to he Abo, to if cam, to he cam, to if Abo, void Abo, void can, to if ba
                                                  //| n, void ban, to Ida an)
